...
--
-- Host: localhost    Database: compliance_ai
-- ------------------------------------------------------
...
CREATE TABLE `reports` (
  ...
  CONSTRAINT `reports_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`project_id`)
...
-- Dump completed on 2026-03-16  0:28:46
